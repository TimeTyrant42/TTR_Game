...
class GameState:
    ...
    def returnListedforP(self):
        ...
        if self.LastP == 'playerOne':
            ...
            return [self.turn, self.LastFullAction, UtrackArray, destPoints, Up1d, Up1c, self.p1Points, self.p2Points]
            ...
            return [self.turn, self.LastFullAction, UtrackArray, destPoints, Up2d, Up2c, self.p2Points, self.p1Points]
